...
Il faudrait se placer sur chacune des autres interfaces, et
comptabiliser le nombre de paquets entrants à destination
de notre interface de sortie en effectuant un routage du paquet.
...
donc compter ceux-ci séparemment. De plus, on ne peut pas router les paquets
car on n'a pas accès la structure représentant le paquet. Il nous faut donc aller un peu plus loin dans le code.
